    ...
    <div className="glass rounded-3xl p-8 border border-white/20 shadow-2xl hover:shadow-purple-500/20 transition-all duration-300">
      ...
      <form onSubmit={handleCreateStream} className="space-y-5">\n        <div className="group">
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-black/40 border border-white/20 rounded-xl text-white placeholder-purple-300/50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
        ...
        <div className="group">
          ...
          <div className="relative">
            <input
              ...
              required
            />
            <div className="absolute right-3 top-1/2 -translate-y-1/2 text-purple-400 font-semibold">
              🪙
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="group">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-black/40 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
              required
            />
          </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="relative w-full bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 hover:from-purple-700 hover:via-pink-700 hover:to-blue-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-purple-500/50 hover:shadow-purple-500/80 hover:scale-[1.02] shine overflow-hidden"
        >
          {loading ? (
